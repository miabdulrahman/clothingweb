      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          <motion.div
            ...
            className={`relative w-full ${sizeClasses[size]} bg-brand-cream border border-brand-charcoal/10 shadow-2xl p-6 md:p-8 z-10 flex flex-col`}
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-brand-charcoal/10">
              ...
              <button
                onClick={onClose}
                className="text-brand-charcoal/50 hover:text-brand-charcoal p-1 transition-colors focus:outline-none"
